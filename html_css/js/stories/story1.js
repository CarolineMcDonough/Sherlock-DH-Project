...
// setTimeout(() => {
//     document.getElementById("storyXMLbody").innerHTML;
//   }, 1000)
...
document.getElementById("male").addEventListener("click", (e) => {
   if(e.target.checked) {
      ...
      document.querySelectorAll(".male").forEach((maleAction) => {
         ...
         maleAction.style.setProperty('background-color', 'blue');

      });
   }
   else {
      //unset male background stuff
   }
});
document.getElementById("storyXMLbody").innerHTML = `
<h2>VII. THE ADVENTURE OF THE BLUE CARBUNCLE</h2>
</span> upon the second morning after Christmas,
...
<q class="johnWatson">I suppose,</q> I remarked, <q class="johnWatson">that, homely as it looks, this thing has some
...
laughing. <q class="sherlockHolmes">Only one of those whimsical little
   ...
   such.</q></p>
<p><q class="johnWatson">So much so,</q> I remarked, <q class="johnWatson">that of the last six cases which I have added
...
characteristic of him. <q class="sherlockHolmes">It is perhaps less
   suggestive than it might have been,</q> he remarked, <q class="sherlockHolmes">and yet there are a few inferences
   which
...
and settled upon the bridge of his nose. <q class="sherlockHolmes">It
   is a question of cubic capacity,</q> said he; <q class="sherlockHolmes">a man with so large a brain must have
   something in it.</q></p>
...
Holmes thoughtfully, tossing aside the paper. <q class="sherlockHolmes">The question for us now to solve is the
...
<q class="sherlockHolmes">It's a bonny thing,</q> said he. <q class="sherlockHolmes">Just see how it glints and
   sparkles. Of
...
easy air of geniality which he could so readily assume. <q class="sherlockHolmes">Pray take this chair by the fire,
   Mr.
...
<p>The man burst into a hearty laugh. <q class="henryBaker">They might be
   useful to me as relics of my adventure,</q> said he, <q class="henryBaker">but beyond that I can hardly see what
   use the
...
<p><q class="henryBaker">Certainly, sir,</q> said <span class="male" title="henryBaker">Baker, who had risen
   and tucked his newly gained property under his arm</span>. <q class="henryBaker">There are a few of us who
   frequent the Alpha
...
buttoning up his coat as we came out into the frosty air. <q class="sherlockHolmes">Remember, Watson that though we
   have so
...
<p><span class="male" title="sherlockHolmes">Sherlock Holmes hailed a
   four-wheeler</span> which was passing. <q class="sherlockHolmes">In that case we had better discuss it in a
...
of colour into his cheeks, and <span class="male" title="jamesRyder">he sat staring</span> with frightened eyes at
his
accuser.</p>
...
<p>Ryder passed his tongue over his parched lips. <q class="jamesRyder">I will
   tell you it just as it happened, sir,</q> said he. <q class="jamesRyder">When Horner had been arrested, it seemed
   to me
...
<p><q class="jamesRyder"><q class="maggieRyder">Whatever were you doing
   ...
   <q class="maggieRyder">Oh,</q><br /> says she, <q class="maggieRyder">we've set yours aside for you—Jem's
   ...
   <q class="jamesRyder">Thank you, Maggie,</q><br /> says I; <q class="jamesRyder">but if it is all the same to you,
      I'd
   ...
   <q class="jamesRyder">Never mind. I'll have the other, and I'll
      ...
      just as you like,</q><br /> said she, a little huffed. <q class="maggieRyder">Which is it you want,
      then?</q><br />
...
<p><q class="jamesRyder">Well, then, of course I saw it all, and <span class="male" title="jamesRyder">I ran off as
